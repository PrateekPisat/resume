<template>
    <p class="text-2xl font-bold">Techinical Knowledge</p>
    <hr class="border-black text-center text-2xl" data-hr-content="" style="--bg:white; --p:0 10px; --trans-x:-50%; --trans-y:-50%;" />
